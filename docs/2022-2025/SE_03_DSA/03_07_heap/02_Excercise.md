...
- https://leetcode.com/problems/kth-largest-element-in-an-array/submissions/2135713021/
- check above drawing
- `O(n log k)`
...
> original sol by [binary-search](../03_06_Binary-Search/01_Exercise.md#378-kth-smallest-element-in-a-sorted-matrix-)
